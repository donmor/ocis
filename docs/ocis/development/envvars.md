...
If you are going to create new ones or deprecate existing ones, you must read the [Envvar Naming Scope]({{< ref "services/general-info/envvars/envvar-scopes.md" >}}) and the 
